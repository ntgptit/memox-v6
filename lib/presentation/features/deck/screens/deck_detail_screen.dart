...
class _DeckContent extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MxAsyncBuilder<List<Deck>>(
      ...
      loading: (context) => const _DeckRowsSkeleton(),
      errorTitle: l10n.somethingWentWrongMessage,
      data: (context, childDecks) => MxAsyncBuilder<List<Flashcard>>(
        ...
        loading: (context) => childDecks.isEmpty
            ? const _CardRowsSkeleton()
            : const _DeckRowsSkeleton(),
        errorTitle: l10n.somethingWentWrongMessage,
...
class _DeckRowsSkeleton extends StatelessWidget {
  const _DeckRowsSkeleton();
            ...
            const MxCard(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  MxGap.s4(),
                  Expanded(child: _SkeletonLines(first: 0.6, second: 0.4)),
                ],
              ),
            ),
        ],
...
class _CardRowsSkeleton extends StatelessWidget {
  const _CardRowsSkeleton();
        ...
        children: <Widget>[
          for (var i = 0; i < 5; i++) ...const <Widget>[
            MxCard(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(child: _SkeletonLines(first: 0.45, second: 0.65)),
                  MxGap.s4(),
...
/// kit's `space-2` rhythm. Widths are fractions of the row, as in the kit.
class _SkeletonLines extends StatelessWidget {
  const _SkeletonLines({required this.first, required this.second});
    ...
    return Column(
      ...
      children: <Widget>[
        FractionallySizedBox(
          ...
          widthFactor: first,
          child: const MxSkeleton(height: 14),
        ),
        const MxGap.s2(),
        FractionallySizedBox(
          alignment: Alignment.centerLeft,
