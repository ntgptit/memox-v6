...
class WatchLibraryUseCase {
  ...
  /// Library rows: roots with their list-surface counters.
  Stream<List<DeckSummary>> rootSummariesOf(String languagePairId) {
    return _decks.watchRootSummaries(languagePairId);
  }
}
