...
| `3.4` | **Ready** | DG-02, DG-05 | Kit MxCard/MxList/MxIconTile/MxSectionHeader contracts + CSS | `AC-WBS-3.4-01`; `TEST-WBS-3.4-01` | `docs/wbs/implementation-packets/WBS-3.4-card-list-surfaces.md` | Child A Done (2026-07-19): `mx_card.dart` + 8 tests; children B–C pending |
