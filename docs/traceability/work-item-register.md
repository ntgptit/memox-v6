...
| `4.4` | In progress (A Done) | DG-06 | WBS 4.4 DAO rules, SQL-first directive, business ownership map | `AC-WBS-4.4-01`; `TEST-WBS-4.4-01` | `docs/wbs/implementation-packets/WBS-4.4-dao-layer.md` | Child A content DAOs (`daos/{language_pair,deck,flashcard}_dao.dart` over `queries/*.drift`) + 8 DAO contract tests (2026-07-19); children B (progress), C (session) pending |
