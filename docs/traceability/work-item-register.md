...
| `5.2.3` | In progress (A, B Done) | DG-01 | create-deck.md §§3–7, full-screen first-run rules | `AC-WBS-5.2.3-01`; `TEST-WBS-5.2.3-01` | `docs/wbs/implementation-packets/WBS-5.2.3-first-run-setup.md` | Children A+B: landing + Not-now + description support + full two-step setup (drafts across steps, kept-id idempotent submit, inline dup/validation) + 7 widget tests + extended E2E (2026-07-19); child C (callout/evidence) pending |
