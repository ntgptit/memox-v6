...
| `5.2.4` | In progress (A, B Done) | DG-01 | browse-nested/open-deck/create-deck §7–8 | `AC-WBS-5.2.4-01`; `TEST-WBS-5.2.4-01` | `docs/wbs/implementation-packets/WBS-5.2.4-library-open-deck.md` | Children A+B: reactive Library root + §7 callout + real Open Deck with Empty/Leaf/Parent stream-derived branching, nested push/back, not-found (2026-07-19); child C (dialog + states/evidence) pending |
