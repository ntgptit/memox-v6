...
| `5.2.4` | In progress (A Done) | DG-01 | browse-nested/open-deck/create-deck §7–8 | `AC-WBS-5.2.4-01`; `TEST-WBS-5.2.4-01` | `docs/wbs/implementation-packets/WBS-5.2.4-library-open-deck.md` | Child A: reactive Library root + transferred §7 callout (highlight/open/dismiss) + deck route placeholder (2026-07-19); children B (open-deck branching), C (dialog + states/evidence) pending |
