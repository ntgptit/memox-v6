...
| `4.4` | In progress (A, B Done) | DG-06 | WBS 4.4 DAO rules, SQL-first directive, business ownership map | `AC-WBS-4.4-01`; `TEST-WBS-4.4-01` | `docs/wbs/implementation-packets/WBS-4.4-dao-layer.md` | Children A+B: 8 DAOs over `queries/*.drift` (content + progress/attempts/preferences/goals/streaks) + 14 DAO contract tests (2026-07-19); child C (session) pending |
