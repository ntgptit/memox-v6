...
| `3.4` | **Ready** | DG-02, DG-05 | Kit MxCard/MxList/MxIconTile/MxSectionHeader contracts + CSS | `AC-WBS-3.4-01`; `TEST-WBS-3.4-01` | `docs/wbs/implementation-packets/WBS-3.4-card-list-surfaces.md` | Children A–B Done (2026-07-19): `mx_card.dart`, `mx_list.dart`, `mx_icon_tile.dart` + 16 tests; child C pending |
