...
| `4.2` | In progress (A Done) | DG-06 | `docs/database/schema-v1.md`, ADR-004, SQL-first .drift directive | `AC-WBS-4.2-01`; `TEST-WBS-4.2-01` | `docs/wbs/implementation-packets/WBS-4.2-schema-v1.md` | Child A content tables in `data/database/tables/content.drift` + 6 DDL contract tests, FK pragma in beforeOpen (2026-07-19); children B (progress/rhythm), C (session runtime) pending |
