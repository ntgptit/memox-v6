...
| `3.5` | **Ready** | DG-02, DG-05 | Kit MxScaffold contract, screen-shell guard rules, responsive contract | `AC-WBS-3.5-01`; `TEST-WBS-3.5-01` | `docs/wbs/implementation-packets/WBS-3.5-scaffold-shells.md` | Children A–B Done (2026-07-19): `layouts/{mx_content_shell,mx_scaffold,mx_constrained_scaffolds}.dart` + 10 tests; child C pending |
