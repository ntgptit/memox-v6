...
| `4.6` | In progress (A Done) | DG-06, ADR-005 | WBS 4.6, schema-v1 atomic operations 1–7 | `AC-WBS-4.6-01`; `TEST-WBS-4.6-01` | `docs/wbs/implementation-packets/WBS-4.6-repositories.md` | Child A content ports + Drift impls, `ConflictFailure` codes via `sqlite_error_mapper`, atomic op 1 with idempotent retry + rollback tests (2026-07-19); children B (progress), C (session) pending |
