...
| `4.6` | In progress (A, B Done) | DG-06, ADR-005 | WBS 4.6, schema-v1 atomic operations 1–7 | `AC-WBS-4.6-01`; `TEST-WBS-4.6-01` | `docs/wbs/implementation-packets/WBS-4.6-repositories.md` | Children A+B: 7 ports + Drift impls; ops 1/4/6 atomic with idempotency + revision guard + rollback tests (2026-07-19); child C (session, ops 2/3/5) pending |
