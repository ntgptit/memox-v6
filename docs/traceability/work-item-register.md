...
| `2.8` | **Ready** | DG-02 | WBS §5.3 width contract, kit layout roles, ADR-002 | `AC-WBS-2.8-01`; `TEST-WBS-2.8-01` | `docs/wbs/implementation-packets/WBS-2.8-responsive-foundation.md` | Child A Done (2026-07-19): `lib/core/theme/responsive/app_breakpoints.dart` + boundary tests; children B–C pending |
