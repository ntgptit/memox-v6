...
| `3.3` | **Ready** | DG-02, DG-05 | Kit MxTextField contract + `.field` CSS, hooks guard contract | `AC-WBS-3.3-01`; `TEST-WBS-3.3-01` | `docs/wbs/implementation-packets/WBS-3.3-mx-text-field.md` | Child A Done (2026-07-19): `inputs/mx_text_field.dart` + `fieldLabel` role + 9 tests; children B–C pending |
