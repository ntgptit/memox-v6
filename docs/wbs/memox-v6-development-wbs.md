...
| --- | --- | --- |
| Done | `0.1–0.6`, `1.1–1.11`, `2.1–2.10`, `3.1–3.7`, `3.9–3.10`, `3.12`, `4.1–4.10`, `5.1.1–5.1.3`, `5.2.1–5.2.6`, `5.3.1`, `5.4.1`, `P0.3` | Durable evidence is in the work-item register. Wave 2 (token→theme→responsive) is closed; the `4.10` foundation gate and the `3.12` minimal-`Mx*` gate both PASSED (2026-07-19). `5.1.2`, `5.2.1` and `5.2.3` were reopened on 2026-07-20 for `MX-VIS-005`/`014`/`015` and re-closed on 2026-07-21 with those states measured. |
...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. PROCESS RULE (owner, 2026-07-19): no screen-changing PR merges without kit-parity evidence <3%. Next: `5.4.2` (due/new/relearn query policy), which owns the `int-2` defect — `5.4.1` has now made "New = Box 0" true by construction, so the counter query reading New as a missing progress row is provably wrong. Then `5.3.2` children B/C. |
