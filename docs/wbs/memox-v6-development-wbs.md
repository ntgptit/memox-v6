...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `3.5` (`MxScaffold` and content shells, XL). |
