...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Current XL in progress: `3.5` (child A Done; B–C pending). |
