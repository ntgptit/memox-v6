...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `4.8` (DI graph), then `1.8` guard profile and the `4.10` foundation gate; the 3.12 minimal gate follows 4.10. |
