...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `4.2` children B/C (progress/rhythm, session runtime), then `4.3` constraints; the 3.12 minimal gate follows 4.10. |
