...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `4.4` (DAO layer, XL — child boundaries by domain), then `4.5` mappers; the 3.12 minimal gate follows 4.10. |
