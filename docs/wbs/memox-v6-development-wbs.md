...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Gates 4.10 and 3.12 PASSED (2026-07-19). 5.1 block complete (2026-07-19). 5.2 Deck block complete (2026-07-19). Next promotion candidate once packeted: `5.3.1` (Flashcard domain/data, XL — child boundaries in packet). |
