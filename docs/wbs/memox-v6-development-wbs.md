...
| --- | --- | --- |
| Done | `0.1–0.6`, `1.1–1.6`, `1.9`, `2.1–2.2` | Durable evidence is in the work-item register. |
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidates once packeted: `2.3`–`2.5`. |
