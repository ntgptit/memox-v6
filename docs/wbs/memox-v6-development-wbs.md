...
| --- | --- | --- |
| Done | `0.1–0.6`, `1.1–1.11`, `2.1–2.10`, `3.1–3.7`, `3.9–3.10`, `3.12`, `4.1–4.10`, `5.1.1–5.1.3`, `5.2.1–5.2.6`, `5.3.1`, `5.4.1–5.4.3`, `P0.3` | Durable evidence is in the work-item register. Wave 2 (token→theme→responsive) is closed; the `4.10` foundation gate and the `3.12` minimal-`Mx*` gate both PASSED (2026-07-19). `5.1.2`, `5.2.1` and `5.2.3` were reopened on 2026-07-20 for `MX-VIS-005`/`014`/`015` and re-closed on 2026-07-21 with those states measured. |
...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. PROCESS RULE (owner, 2026-07-19): no screen-changing PR merges without kit-parity evidence <3%. `5.4.4` **child A landed 2026-07-25** (schema v2: the `srsActivatedAt`/`lastReviewedAt` columns and their round trip; packet `WBS-5.4.4-attempt-schedule-transaction.md`). Next: `5.4.4` children B (concurrent-writer interleaving for `SRS8-012`) and C (exactly-once across restart), then `5.4.5`, then `5.3.2` children B/C. |
