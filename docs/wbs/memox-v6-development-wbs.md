...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `4.2` (schema v1, XL — child boundaries per table group; the 3.12 minimal gate follows 4.10). |
