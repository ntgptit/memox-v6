...
| Blocked | All remaining implementation rows | Preserve dependency order; create/review the item packet immediately before promotion. Next promotion candidate once packeted: `1.10` (shared test infrastructure), then `1.11` → `4.8` DI graph; the 3.12 minimal gate follows 4.10. |
