...
(function () {
  const CATALOG = {
    ...
    vi: {
      'account.signin.title': 'Đồng bộ trên các thiết bị',
      'account.signin.body': 'Đăng nhập để sao lưu và đồng bộ thẻ trên các thiết bị. Ứng dụng vẫn hoạt động ngoại tuyến.',
      'account.signin.google': 'Đăng nhập bằng Google',
      'account.signin.email.label': 'Email',
      'account.signin.email.placeholder': 'ban@example.com',
      'account.signin.password.label': 'Mật khẩu',
      'account.signin.password.placeholder': 'Mật khẩu của bạn',
      'account.signin.emailCta': 'Tiếp tục bằng email',
      'account.alpha': 'Tính năng này đang ở giai đoạn alpha.',
      'account.sync.syncingTitle': 'Đang đồng bộ…',
      'account.sync.syncingSub': 'Đang tải thay đổi lên',
      'reminder.title': 'Nhắc nhở học tập',
      'reminder.sub': 'Nhắc bạn ôn tập mỗi ngày',
      'reminder.timeLabel': 'GIỜ NHẮC',
      'reminder.repeat': 'LẶP LẠI',
      'reminder.permission.title': 'Thông báo đang bị tắt',
      'reminder.permission.body': 'MemoX không thể nhắc bạn cho đến khi thông báo được bật cho ứng dụng này trong cài đặt hệ thống.',
      'reminder.permission.cta': 'Mở Cài đặt',
      'reminder.permission.dismiss': 'Để sau',
      'subdeck.offline': 'Ngoại tuyến · đang hiển thị các bộ thẻ đã lưu. Đồng bộ lần cuối {rel}.',
      'subdeck.notFound.title': 'Bộ thẻ này không còn tồn tại',
      'subdeck.notFound.body': 'Bộ thẻ có thể đã bị xóa hoặc di chuyển trên thiết bị khác. Hãy quay lại thư viện để tiếp tục học.',
      'subdeck.notFound.cta': 'Về Thư viện',
