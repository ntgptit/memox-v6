...
- [ ] **KIT-44-04 — Loading, empty, no-results, error, offline và partial states được ghi khi relevant.**
...
| KIT-44-04 | `specs/dashboard.md`; `specs/mode-picker.md`; `specs/recall-mode.md`; ISS-REB-UI-01 | PARTIAL | Required recovery/study states are specified after rebaseline; current Web/Android light/dark/en/vi evidence is not yet attached. |
